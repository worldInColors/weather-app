function DailyForecastGridItem({ day, icon, tempMax, tempMin, loading }) {
  ...
  return (
    <div className="flex min-h-[150px] flex-1 flex-col items-center rounded-xl border border-neutral-600 bg-neutral-800 px-[10px] py-4">
      <h3>{day}</h3>
...
function LoadingState() {
  return (
    <div className="flex min-h-[150px] flex-1 flex-col items-center rounded-xl border border-neutral-600 bg-neutral-800 px-[10px] py-4"></div>
  );
}
